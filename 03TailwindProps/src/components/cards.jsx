...
function Card({username}){
    ...
    return(
            <div className="md:max-w-sm w-full p-6 rounded-xl mb-9 shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
